...
Tiles::Launcher.launch( "Crawl", 
	...
	app.register_new_channel_class  Channel.name				# NOTE: Registration of channel classes should 
	app.register_new_channel_class  SuperHuman_DEBUG::Channel.name		#	NOT fall in the same context as the game initialization loop
